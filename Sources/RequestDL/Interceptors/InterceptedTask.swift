...
/**
 ...
 An `InterceptedTask` conforms to the `Task` protocol and defines a `result()` method that returns a `Content.Element` object. The `result()` method can throw an error asynchronously.
 */
