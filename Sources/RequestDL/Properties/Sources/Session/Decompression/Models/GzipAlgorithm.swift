...
/// zlib's own incremental `deflate()` API instead, also streaming in bounded memory. If even
/// `zlib` isn't importable, this falls back to ``CompressionUnavailableError`` like
/// ``DeflateAlgorithm`` does in the same case.
