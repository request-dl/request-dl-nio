...
extension Internals {
    ...
    ///
    /// Transport-neutral on purpose (Phase 7b2 of `URLSESSION_TASK.md`) -- fires from
    /// `Internals.CacheControl`'s cache-hit path (`makeCachedSession`) when the caller walks away
