...
extension Internals {
    ...
    package struct FileBufferURL: BufferURL {
        ...
        package static var temporaryURL: Internals.FileBufferURL {
        ...
        package static func make(from url: URL) -> Internals.FileBufferURL? {
            .init(url)
        }
